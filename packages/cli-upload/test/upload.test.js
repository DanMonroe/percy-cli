import { fs, logger, api, setupTest } from '@addepar/percy-cli-command/test/helpers';
import upload from '@addepar/percy-cli-upload';
...
describe('percy upload', () => {
  beforeEach(async () => {
    upload.packageInformation = { name: '@addepar/percy-cli-upload' };
